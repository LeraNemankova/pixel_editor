...
//заливка
let FILL_MODE = false
let COLORS = ['rgb(255, 0, 0)', 'rgb(0, 128, 0)', 'rgb(0, 0, 255)', 'rgb(255, 255, 255)', 'rgb(255, 255, 0)']

//Кнопка мыши опущена / поднята (зажатие)
document.addEventListener('mousedown', function(){
    IS_CLICKED = true;
})

document.activeElement('mouseup', function(){
    IS_CLICKED = false;
})
